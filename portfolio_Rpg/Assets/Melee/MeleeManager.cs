...
public class MeleeManager : vMonoBehaviour
{
    ...
    {
        if (rightWeapon != null && rightWeapon.meleeType != MeleeType.OnlyDefense && rightWeapon.gameObject.activeSelf)
    ...
    public virtual int GetMoveSetID()
    {
        ...
        // if (leftWeapon != null && leftWeapon.gameObject.activeSelf) 
         //   return leftWeapon.MovesetID;
        return 0;
    }
...
[Serializable]
public class vOnHitEvent : UnityEngine.Events.UnityEvent<HitInfo> { }
