...
public class vThirdPersonCamera : MonoBehaviour
{
    ...
    void CalculeLockOnPoint()
    {
        ...
        mouseY = Extensions.ClampAngle(y, currentState.yMinLimit, currentState.yMaxLimit);
        mouseX = Extensions.ClampAngle(x, currentState.xMinLimit, currentState.xMaxLimit);
    }
