...
namespace Rpg.Item
{
    class ItemEnumsBuilder
    {
        public static void RefreshItemEnums()
        {
            ...
            ItemEnumsList[] datas = Resources.LoadAll<ItemEnumsList>("");
            ...
            try
            {
                _itemTypeNames = Enum.GetNames(typeof(ItemType)).vToList();
            }
            catch
            {
            ...
            try
            {
                _itemAttributeNames = Enum.GetNames(typeof(ItemAttributes)).vToList();
            }
            catch
            {
