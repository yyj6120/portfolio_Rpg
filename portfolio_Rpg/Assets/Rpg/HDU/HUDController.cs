...
public class HUDController : MonoBehaviour
{
    ...
    public void Init(ThirdPersonController cc)
    {
    ...
    void UpdateSliders(ThirdPersonController cc)
    {
        //if (cc.maxHealth != healthSlider.fillAmount)
        //{
    ...
    //void UpdateDebugWindow(ThirdPersonController cc)
    //{
    //    if (cc.debugWindow)
    //    {
