...
public class HeadTrack : MonoBehaviour
{
    ...
    protected List<LookTarget> targetsInArea = new List<LookTarget>();
    ...
    private HeadTrackSensor sensor;
    ...
    void LateUpdate()
    {
        ...
        if (useUnityAnimatorIK || (!updateIK && animator.updateMode == AnimatorUpdateMode.AnimatePhysics))
            return;
