...
public class AIAttackControll : StateMachineBehaviour
{
    ...
    {
        var aiManager = animator.GetComponent<AIManager>();
        if (aiManager)
            aiManager.SetActiveAttack( meleeAttackType, value, damageMultiplier, attackName);
    }
