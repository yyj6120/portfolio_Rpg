...
public class AIMotor : Character
{
    ...
    public AISphereSensor sphereSensor;
    ...
    public void CheckTarget()
    {
        ...
        if (colliderTarget == null || colliderTarget.transform != target)
    ...
    public override void TakeDamage(Damage damage, bool hitReaction)
    {
        ...
        if (damage.damageValue > 0)
            SendMessage("TriggerHitParticle", new HittEffectInfo(new Vector3(transform.position.x, damage.hitPosition.y, transform.position.z), hitRotation, damage.attackName , damage.receiver), SendMessageOptions.DontRequireReceiver);
