...
namespace Rpg.Item
{
    public class ItemListWindow : EditorWindow
    {
        ...
        public static void CreateWindow(ItemListData itemList)
        {
            ItemListWindow window = (ItemListWindow)EditorWindow.GetWindow(typeof(ItemListWindow), false, "ItemList Editor");
            Instance = window;
        ...
        public static void CreateWindow(ItemListData itemList, int firtItemSelected)
        {
            ItemListWindow window = (ItemListWindow)EditorWindow.GetWindow(typeof(ItemListWindow), false, "ItemList Editor");
            Instance = window;
            window.itemList = itemList;
        ...
        void DuplicateItem(Item targetItem)
        {
