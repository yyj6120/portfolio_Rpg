...
namespace Rpg.Item
{
    ...
    public class ItemEditor : Editor
    {
        ...
        {
            if (item == null) item = target as Item;
        ...
        void DrawAttributes()
        {
            try
            {
                ...
                {
                    GUILayout.BeginHorizontal("box");
                    attribute = (ItemAttributes)EditorGUILayout.EnumPopup(attribute);
                    ...
                    else
                    {
                        ...
                        {
                            item.attributes.Add(new ItemAttribute(attribute, attributeValue));
    ...
    public class vItemDrawer
    {
        ...
        public vItemDrawer(Item item)
        {
            this.item = item;
            defaultEditor = Editor.CreateEditor(this.item);
        }

        public void DrawItem(ref List<Item> items, bool showObject = true, bool editName = false)
        {
            if (!item) return;
