...
namespace Rpg.Item
{
    public delegate void OnSubmitSlot(ItemSlot slot);
    public delegate void OnSelectSlot(ItemSlot slot);
    public delegate void OnCompleteSlotList(List<ItemSlot> slots);
    ...
    public class ItemWindow : MonoBehaviour
    {
        ...
        public void CreateEquipmentWindow(List<Item> items, List<ItemType> type, Item currentItem = null, OnSubmitSlot onPickUpItemCallback = null, OnSelectSlot onSelectSlotCallBack = null)
        {
        ...
        public void OnSelect(ItemSlot slot)
        {
            if (itemtext != null)
            {
                if (slot.item == null)
