...
namespace Rpg.Item
{
    public class InventoryWindow : MonoBehaviour
    {
        ...
        public List<WindowPop_up> pop_ups = new List<WindowPop_up>();
        ...
        public void AddPop_up(WindowPop_up pop_up)
        {
        ...
        public void RemovePop_up(WindowPop_up pop_up)
        {
            try
            {
                if (pop_ups.Contains(pop_up))
        ...
        {
            foreach (WindowPop_up popup in pop_ups)
            {
                popup.gameObject.SetActive(false);
            }
            pop_ups.Clear();
